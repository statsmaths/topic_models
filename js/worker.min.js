...
var my = {},
    doc_topics_matrix, total_tokens, topic_docs, doc_topics, topic_yearly, yearly_total;
...
topic_docs = function(t, n) {
    ...
    if (n >= docs.length) {
        docs.sort(function(a, b) {
            return utils.desc(a.frac, b.frac) || utils.desc(a.doc, b.doc)
        });
        return docs
    }
    result = docs.slice(0, n).sort(function(a, b) {
        return utils.asc(a.frac, b.frac) || utils.asc(a.doc, b.doc)
    });
    bisect = utils.bisector_left(function(d) {
        return d.frac
    });
...
doc_topics = function(d, n) {
    ...
    topics.sort(function(a, b) {
        return utils.desc(a.weight, b.weight) || utils.desc(a.t, b.t)
    });
